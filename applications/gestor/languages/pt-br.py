...
'Errors': 'Erros',
'Errors in form, please check it out.': 'Erros no formulário, por favor revise o preenchimento.',
...
'Request reset password': 'Requisitar troca de senha',
...
'Users': 'Usuários',
'Value not in database': 'Valor não existe no banco de dados',
